...
//MODER register
#define	GPIOA_MODER_REG			*((volatile uint32_t *)((uint32_t)0x48000000)) /* Add moder register address here. */
//OTYPER register
#define	GPIOA_OTYPER_REG		*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x04U))) /* Add otyper register address here. */
//OSPEEDER register
#define GPIOA_OSPEEDER_REG		*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x08U))) /* Add ospeeder register address here. */
//PUPDR register
#define GPIOA_PUPDR_REG			*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x0CU))) /* Add pupdr register address here. */
//IDR register
#define GPIOA_IDR_REG			*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x10U))) /* Add idr register address here. */
//ODR register
#define GPIOA_ODR_REG			*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x14U))) /* Add odr register address here. */
//BSRR register
#define GPIOA_BSRR_REG			*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x18U))) /* Add bsrr register address here. */
//BRR register
#define GPIOA_BRR_REG			*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x28U))) /* Add brr register address here. */
